...
// FindUserOrders provides a mock function with given fields: ctx, userID
func (_m *Repository) FindUserOrders(ctx context.Context, userID int64) ([]orders.Order, error) {
...
func (_m *Repository) Update(ctx context.Context, order orders.Order) error {
